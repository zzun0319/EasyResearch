	...
	<div class="container">
		...
		<form action="/user/register_otherInfo" method="post" name="reg_form">
			<table>
				...
				<tr>
					<td>학교 이메일 (인증 메일 및 실험 안내 메일이 발송됩니다.)</td>
					<td id="rightColumn">
						<input style="width:60%;" value="${umvo.univEmail}">
				...
				<tr>
					<td>휴대폰 번호</td>
					<td id="rightColumn">
						<input style="width:60%;" type="text" name="phoneNum" id="user_phoneNum" placeholder=" - 없이 숫자만 입력해주세요."> &nbsp; &nbsp;
