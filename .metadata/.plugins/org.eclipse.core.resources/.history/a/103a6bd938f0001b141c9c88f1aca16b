...
public class UserVO {
	...
	private String univIdNum; // 학번, 교번
	private String email; // 학교 이메일
	private String tel; // 휴대폰 번호
	private String major; // 전공 - 석사, 박사, 교수, 지도교수만
	private String userType; // 학부생, 석사, 박사, 강사, 교수, 지도교수 중 택 1
	private boolean participationRight; // 실험 참가 권한
